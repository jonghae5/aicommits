...
const dacommitsPath = path.resolve("./dist/cli.mjs");

const createdacommits = (fixture: FsFixture) => {
	const homeEnv = {
...
export const createFixture = async (source?: string | FileTree) => {
	...
	const dacommits = createdacommits(fixture);
...
export const files = Object.freeze({
	".dacommits": `OPENAI_KEY=${process.env.OPENAI_KEY}`,
