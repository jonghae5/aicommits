<div align="center">
  <div>
	...
	<a href="https://www.npmjs.com/package/dacommits"><img src="https://img.shields.io/npm/v/dacommits" alt="Current version"></a>
</div>
...
3. Set the key so dacommits can use it:
...
If it's not the [latest version](https://github.com/Nutlope/dacommits/releases/latest), run:

```sh
npm update -g dacommits
```
...
> 👉 **Tip:** Use the `aic` alias if `dacommits` is too long for you.
...
2. dacommits will generate the commit message for you and pass it back to Git. Git will open it with the [configured editor](https://docs.github.com/en/get-started/getting-started-with-git/associating-text-editors-with-git) for you to review/edit it.
